    ...
    <?php }?>
            ...
            <div class="row">
              <div class="col-md-12 text-center">
                <a href="generate_pdf_report.php" class="btn btn-primary" target="_blank">Unduh Laporan PDF</a>
              </div>
            </div>
                  </div>
                </div>
        ...
        <!-- Script untuk menghasilkan laporan PDF -->
        ...
        function generatePDF() {
          ...
          doc.text("Laporan Pemesanan Online", 14, 15);
          
          const table = document.getElementById("datatable-responsive");
          doc.autoTable({ html: table });
          
          doc.save("laporan_pemesanan_online.pdf");
        }
        </script>