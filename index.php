...
<html lang="en">
<head>
  <title>Benteng Sport Center|| Home</title>
  <link rel="shortcut icon" href="assets/images/benteng.png">
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="assets/css/w3.css">
    ...
    body {
      padding-top: 50px;
      background-color: #f4f4f4; /* Modern background color */
      font-family: 'Open Sans', sans-serif; /* Modern font family */
    }
    .modal-title {
      color: #333; /* Modern color for modal title */
    }
    a {
      color: #007bff; /* Modern color for links */
    }
    footer {
      background-color: #333; /* Modern background color for footer */
      padding: 25px;
      color: #fff; /* Modern text color for footer */
    }
    .carousel-inner img {
      width: 100%;
      margin: auto;
      min-height: 200px;
      border-radius: 10px; /* Modern border radius for images */
    }
     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
         ...
         <div class="carousel-inner" role="listbox">
           <div class="item active">
             <img src="assets/futsal/b2.jpg" alt="Image">
           ...
           <div class="item">
             <img src="assets/futsal/b3.jpg" alt="Image">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/futsal/b4.jpg" alt="Image">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/futsal/b5.jpg" alt="Image">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/futsal/b6.jpg" alt="Image">
             <div class="carousel-caption">
           ...
           <div class="item">
             <img src="assets/futsal/b8.jpg" alt="Image">
             <div class="carousel-caption">
           ...
           <div class="item">
             <img src="assets/futsal/b11.jpg" alt="Image">
             <div class="carousel-caption">
