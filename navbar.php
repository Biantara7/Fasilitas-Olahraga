      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Benteng Sport Center</a>
          </div>
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost/project/Home/index.php">BENTENG SPORT CENTER</a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="member/member_daftar.php">Daftar</a></li>
              
              <form class="navbar-form navbar-right">
                &nbsp;&nbsp;&nbsp;&nbsp;Atau Masuk sebagai &nbsp;
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Pelanggan</button>
