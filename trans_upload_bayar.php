        ...
        <div class="panel panel-default">
          ...
          <form class="form-horizontal form-label-left" action="trans_upload_save.php" method="post" enctype="multipart/form-data">
			...
			?>
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-5 col-sm-5 col-xs-12" for="first-name">Nama Pengirim <span class="required"></span>
                            </label>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <div class="radio">
                                  <label><input type="radio" name="rek_tuju" value="dana"><img src="assets/images/dana.png" style="width:512px; height:512px;"> 0896-7649-0312 (an. Fikti Lukman R)</label>
                                </div>
                                <br>
                                <div class="radio">
                                  <label><input type="radio" name="rek_tuju" value="bri"><img src="assets/images/bri.gif" style="width:80px; height:30px;"> 9742-233-2552-23 (an. Hendra Irawan)</label>
                                </div>
                                <br>
                                <div class="radio">
                                  <label><input type="radio" name="rek_tuju" value="mandiri"><img src="assets/images/mandiri.png" style="width:80px; height:30px;"> 9000-0108-927-36 (an. Amalia Domas)</label>
                                </div>
                            </div>
                          </div>
                          <br>
